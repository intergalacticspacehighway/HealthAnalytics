            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Book Appointment</h4> </div>
                        ...
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <form class="form-material form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12" for="date-time">Date Time</span><span class="text-muted font-12 p-l-20">(e.g. "12/10/2016 05:15 pm")</span></label>
                                        <div class="col-md-12">
