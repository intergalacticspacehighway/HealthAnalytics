            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add speciality</h4> </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <form:form class="form-material form-horizontal" action="insertSpeciality.html" method="post" modelAttribute="insertSpeciality">
                                    <div class="form-group">
                                        <label class="col-md-12" for="example-text">Speciality Name</span></label>
                                        <div class="col-md-12">
                                            <form:input type="text" id="specialityName" path="specialityName" class="form-control" placeholder="Enter speciality name"/>
                                        </div>
