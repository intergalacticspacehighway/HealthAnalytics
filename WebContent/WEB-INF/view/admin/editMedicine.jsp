                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <form:form class="form-material form-horizontal" action="updateMedicine.html" method="post" modelAttribute="updateMedicine">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <form:input type="hidden" path="medicineId" class="form-control" value="${i.medicineId }"/>  
                                            <form:input type="hidden" path="isActive" class="form-control" value="Yes"/> 
                                            
                                            <form:input type="text" id="medicineName" path="medicineName" class="form-control" value="${i.medicineName }"/>
                                        </div>
                                    </div>
