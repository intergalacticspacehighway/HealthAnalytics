...
<<<<<<< HEAD
                        <h4 class="page-title">View Doctor</h4> </div>
...
>>>>>>> parent of 0aea795... Revert "Buy now deleted"
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                    </div>
							...
							<table class="table table-hover">
							   ...
							   <c:forEach items="${sessionScope.dlist}" var="doctor" varStatus="myindex">
									...
									<tr class="rowContent">
										...
										<td class="jqueryCheck">${doctor.doctorName}</td>
										
										<td class="jqueryCheck2">
										
								<c:forEach items="${sessionScope.dslist}" var="i" varStatus="status">
										
										<c:if test="${i.doctor.doctorId == doctor.doctorId }">
										...
										<td><a href ="editDoctor.html?doctorId=${doctor.doctorId}">Edit</a></td>
										<td><a href ="deleteDoctor.html?doctorId=${doctor.doctorId}">Delete</a></td>
										<td class="active">${doctor.isActive}</td> 
