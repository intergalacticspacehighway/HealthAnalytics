...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <div class="m-t-20">
                                ...
                                <div class="calendar-event" data-class="bg-primary">My Event Five <a href="javascript:void(0);" class="remove-calendar-event"><i class="ti-close"></i></a></div>
    ...
    <script src="resources/js/jquery.fullcalendar.js"></script>
    <!--Style Switcher -->
