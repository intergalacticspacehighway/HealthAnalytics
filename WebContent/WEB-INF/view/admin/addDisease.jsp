                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <form:form class="form-material form-horizontal" action="insertDisease.html" modelAttribute="insertDisease" method="post">
                                    <div class="form-group">
                                        ...
                                        <form:input type="hidden" path="isActive" name="isActive" value="Yes"/>
                                    </div>
