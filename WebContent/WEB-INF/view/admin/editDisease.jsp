            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edit Disease</h4> </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <form:form class="form-material form-horizontal" action="updateDisease.html" method="post" modelAttribute="updateDisease">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <form:input type="hidden" path="diseaseId" class="form-control" value="${i.diseaseId }"/>  
                                            <form:input type="hidden" path="isActive" class="form-control" value="Yes"/> 
                                            
                                            <form:input type="text" id="diseaseName" path="diseaseName" class="form-control" value="${i.diseaseName }"/>
                                        </div>
                                    </div>
