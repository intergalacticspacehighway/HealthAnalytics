							...
							<table class="table table-hover">
								...
								<tbody class="rowBody">
									...
									<tr class="rowContent">
										...
										<td><a href ="deleteDisease.html?id=${i.diseaseId}">Delete</a></td>
										<td class="active">${i.isActive}</td>
										<td>
										<button type="button" class="btn btn-success" onclick="window.location.href='DiseaseisActivechange.html?id=${i.diseaseId}'">Change</button>
										</td>
