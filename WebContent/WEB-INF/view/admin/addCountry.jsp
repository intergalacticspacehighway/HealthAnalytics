				...
				<div class="row">
					<div class="col-sm-12">
						<div class="white-box">
							...
							<form:form class="form-material form-horizontal"
								action="insertCountry.html" method="post"
								modelAttribute="insertCountry">
								<div class="form-group">
									<label class="col-md-12" for="example-text">Country
										Name</span>
									</label>
									<div class="col-md-12">
										<form:input type="text" id="countryName" path="countryName"
											class="form-control" placeholder="Enter country name" />
									</div>
									<form:input type="hidden" id="isActiveId" path="isActive"
