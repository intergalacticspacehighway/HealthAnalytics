				...
				<div class="row">
					<div class="col-sm-12">
						<div class="white-box">
							...
							<form:form class="form-material form-horizontal" action="insertSymptom.html" method="post" modelAttribute="insertSymptom">
								<div class="form-group">
									<label class="col-md-12" for="symptomName">Symptom Name</span></label>
									<div class="col-md-12">
										<input type="text" id="symptomName" name="symptomName" path="symptomName"
											class="form-control" placeholder="Enter symptom name">
									</div>
